...
public class IseSettings extends PreferenceActivity {
	...
	private void initUI() {
		...
		mCategoryPref.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
		...
		mResultLevelPref.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
		...
		mVadBosPref.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
		...
		mVadEosPref.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
		...
		mSpeechTimeoutPref.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
