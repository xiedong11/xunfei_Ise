 ...
 *
 */
package com.zhuandian.myapplication.ise.result.xml;

import android.text.TextUtils;
import android.util.Xml;


import com.zhuandian.myapplication.ise.result.FinalResult;
import com.zhuandian.myapplication.ise.result.ReadSentenceResult;
import com.zhuandian.myapplication.ise.result.ReadSyllableResult;
import com.zhuandian.myapplication.ise.result.ReadWordResult;
import com.zhuandian.myapplication.ise.result.Result;
import com.zhuandian.myapplication.ise.result.entity.Phone;
import com.zhuandian.myapplication.ise.result.entity.Sentence;
import com.zhuandian.myapplication.ise.result.entity.Syll;
import com.zhuandian.myapplication.ise.result.entity.Word;
            ...
            while (XmlPullParser.END_DOCUMENT != eventType) {
                switch (eventType) {
                    case XmlPullParser.START_TAG:
                        ...
                        } else if ("phone_score".equals(pullParser.getName())) {
                            finalResult.phone_score = getFloat(pullParser, "value");
                        } else if ("tone_score".equals(pullParser.getName())) {
                            finalResult.tone_score = getFloat(pullParser, "value");
